...
private:
    ...
    class BuilderBase {
    protected:
        std::vector<std::deque<SingleAttrRhsStrippedFd>> stripped_fds_;
    ...
    /*
    auto FullView() const {
        return std::ranges::views::transform(stripped_fds_,
                                             [this](SingleAttrRhsStrippedFd const& stripped_fd) {
